...
const fnSubmit = async () => {
    ...
    const variables = {
        ...
        birthTime: oneInfo.birthday.getTime(), //出生日期   
        address: oneInfo.detailedAddress, //详细地址
    }
    let res = await applySave({
        applyType: "OUTSIDE_SCHOOL", //申请类型,可用值:ENTRY,RETIRE,TRANSFER,LOAN,SICK_LEAVE,MATERNITY_LEAVE,UPDATE
        targetId: "", //申请对象id
        targetName: "", //申请对象
